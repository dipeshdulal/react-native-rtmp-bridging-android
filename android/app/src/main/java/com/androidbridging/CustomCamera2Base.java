...
public abstract class CustomCamera2Base implements GetAacData, GetVideoData, GetMicrophoneData {
    ...
    @Deprecated
    public CustomCamera2Base(SurfaceView surfaceView) {
    ...
    @Deprecated
    public CustomCamera2Base(TextureView textureView) {
        this.textureView = textureView;
        this.context = textureView.getContext();
        init(context);
    }

    public CustomCamera2Base(OpenGlView openGlView) {
    ...
    public CustomCamera2Base(CustomOpenGLView openGlView) {
        context = openGlView.getContext();
        glInterface = openGlView;
        glInterface.init();
        init(context);
    ...
    public CustomCamera2Base(LightOpenGlView lightOpenGlView) {
    ...
    public CustomCamera2Base(Context context, boolean useOpengl) {
     ...
     * @see com.pedro.rtplibrary.base.Camera2Base#getMaxZoom()
     */
