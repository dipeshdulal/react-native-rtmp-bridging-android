...
public class CustomRTMPCamera2 extends CustomCamera2Base {
     ...
     */
    @Deprecated
    public CustomRTMPCamera2(SurfaceView surfaceView, ConnectCheckerRtmp connectChecker) {
        super(surfaceView);
     ...
     */
    @Deprecated
    public CustomRTMPCamera2(TextureView textureView, ConnectCheckerRtmp connectChecker) {
        super(textureView);
        srsFlvMuxer = new SrsFlvMuxer(connectChecker);
    }

    public CustomRTMPCamera2(OpenGlView openGlView, ConnectCheckerRtmp connectChecker) {
        super(openGlView);
        srsFlvMuxer = new SrsFlvMuxer(connectChecker);
    }

    public CustomRTMPCamera2(CustomOpenGLView openGlView, ConnectCheckerRtmp connectChecker) {
        super(openGlView);
        srsFlvMuxer = new SrsFlvMuxer(connectChecker);
    }

    public CustomRTMPCamera2(LightOpenGlView lightOpenGlView, ConnectCheckerRtmp connectChecker) {
        super(lightOpenGlView);
        srsFlvMuxer = new SrsFlvMuxer(connectChecker);
    }

    public CustomRTMPCamera2(Context context, boolean useOpengl, ConnectCheckerRtmp connectChecker) {
